...
def generate_patch_image_cv(cvimg, c_x, c_y, bb_width, bb_height, patch_width,
                            patch_height, do_flip, scale, rot):
    img = cvimg.copy()
    ...
    trans = gen_trans_from_patch_cv(c_x,
                                    c_y,
                                    bb_width,
                                    bb_height,
                                    patch_width,
...
def crop_image(image, kp_2d, center_x, center_y, width, height, patch_width,
               patch_height, do_augment):
    ...
    image, trans = generate_patch_image_cv(image, center_x, center_y, width,
                                           height, patch_width, patch_height,
                                           do_flip, scale, rot)
...
def transfrom_keypoints(kp_2d, center_x, center_y, width, height, patch_width,
                        patch_height, do_augment):
